...
I have a broad interest in robot dynamics by combining (Bayesian) machine learning and the principles of dynamic control. Currently, I am interested in Bayesian deep learning and (multi-agent) reinforcement learning for system identification, state estimation, planning and control.

Recent News 
======
* June 8, <span style="color:red">**One Postdoc position openning**</span> on "Bayesian Learning for Robotics". [Apply Now!](https://www.academictransfer.com/en/301477/postdoc-bayesian-learning-for-robotics/)
