...
I have a broad interest in robot dynamics by combining Bayesian machine learning and the principles of dynamic control. Currently, I am interested in (Bayesian) deep learning and (Bayesian, multi-agent) reinforcement learning for design, physical system identification, state estimation, planning and control in robotics.
