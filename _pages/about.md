...
Recent News 
======
* November 11, 2021, together with [Rajendra Bishnoi](https://scholar.google.de/citations?user=eb8vnpQAAAAJ&hl=en), we will build an Delft AI Lab working on <em>Bayesian deep spiking learning</em> and <em>neuromorphic processor architecture</em> with applications in <em>healthcare</em>. PhD positions are available!
