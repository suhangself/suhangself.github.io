...
* Guest Associate Editor:
    * IEEE Transactions on Fuzzy Systems (Impact Factor 9.518)
      <br>Special Issue on Cyborg Intelligence: Human Enhancement with Fuzzy Sets</br>
    * IEEE Robotics and Automation Letters (Impact Factor 3.608)
      <br>Autonomous System in Robotic Surgery: Current Challenges in Design, Modeling, Perception, Control and Applications</br>
